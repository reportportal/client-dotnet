...
namespace ReportPortal.Client.Resources
{
    class ServiceUserFilterResource : ServiceBaseResource, IUserFilterResource
    {
        ...
        public async ValueTask<Content<UserFilterResponse>> GetAsync()
        {
            return await GetAsync(filterOption: null, CancellationToken.None).ConfigureAwait(false);
        }

        public async ValueTask<Content<UserFilterResponse>> GetAsync(FilterOption filterOption)
        {
            return await GetAsync(filterOption, CancellationToken.None).ConfigureAwait(false);
        }

        public async ValueTask<Content<UserFilterResponse>> GetAsync(CancellationToken cancellationToken)
        {
            return await GetAsync(filterOption: null, cancellationToken).ConfigureAwait(false);
        }

        public async ValueTask<Content<UserFilterResponse>> GetAsync(FilterOption filterOption, CancellationToken cancellationToken)
        {
        ...
        public async ValueTask<UserFilterCreatedResponse> CreateAsync(CreateUserFilterRequest request)
        {
            return await CreateAsync(request, CancellationToken.None).ConfigureAwait(false);
        }

        public async ValueTask<UserFilterCreatedResponse> CreateAsync(CreateUserFilterRequest request, CancellationToken cancellationToken)
        {
        ...
        public async ValueTask<MessageResponse> UpdateAsync(long id, UpdateUserFilterRequest request)
        {
            return await UpdateAsync(id, request, CancellationToken.None).ConfigureAwait(false);
        }

        public async ValueTask<MessageResponse> UpdateAsync(long id, UpdateUserFilterRequest request, CancellationToken cancellationToken)
        {
        ...
        public async ValueTask<UserFilterResponse> GetAsync(long id)
        {
            return await GetAsync(id, CancellationToken.None).ConfigureAwait(false);
        }

        public async ValueTask<UserFilterResponse> GetAsync(long id, CancellationToken cancellationToken)
        {
