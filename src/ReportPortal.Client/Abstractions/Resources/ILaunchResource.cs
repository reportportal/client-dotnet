...
namespace ReportPortal.Client.Abstractions.Resources
{
    ...
    public interface ILaunchResource
    {
        ...
        Task<Content<LaunchResponse>> GetAsync(FilterOption filterOption = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A list of launches.</returns>
        Task<Content<LaunchResponse>> GetDebugAsync(FilterOption filterOption = null, CancellationToken cancellationToken = default);
